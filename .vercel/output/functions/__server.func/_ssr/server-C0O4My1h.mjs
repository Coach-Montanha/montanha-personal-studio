...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DwGxZQO1.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-hcJUAVQX.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BVdmo8PO.mjs"),
		import("./start-CeK9kFdX.mjs"),
